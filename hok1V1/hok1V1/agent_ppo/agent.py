...
STAGE_A_PLUS_SUMMONER_SKILL_ID = 80108
...
class Agent(BaseAgent):
    ...
    def init_config(self, config_data):
        ...
        for hero_id in my_heroes:
            select_skills[hero_id] = STAGE_A_PLUS_SUMMONER_SKILL_ID
    ...
    def load_model(self, path=None, id="1"):
        ...
        if self.cur_model_name == model_file_path:
            ...
            try:
                ...
                self.logger.warning(f"skip incompatible model {model_file_path}: {e}")
